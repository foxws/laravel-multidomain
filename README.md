...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-multidomain.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-multidomain)
...
```bash
php artisan vendor:publish --tag="laravel-multidomain-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-multidomain-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-multidomain-views"
```
